    ...
    515463: function (e, t, n) {
      ...
      class de extends se {
        ...
        static create(e, t, n, o) {
          ...
          return (
            ...
            new de(e, t, r.dom, r.contentDOM || r.dom)
          );
        }
        parseRule() {
          ...
          for (let n in t)
            e.input.eventHandlers[n] ||
              e.dom.addEventListener(
                n,
                (e.input.eventHandlers[n] = (t) => pt(e, t))
              );
        });
      }
      function pt(e, t) {
        ...
        return (
          ...
          (s
            ? (function (e, t) {
                ...
                return (
                  null != i &&
                  (bt(e, o.qv.create(e.state.doc, i), "pointer"), !0)
                );
              })(e, n)
            : (function (e, t) {
                if (-1 == t) return !1;
        ...
        return (
          ...
          (function (e, t, n) {
            ...
            if (-1 == t)
              return (
                !!i.inlineContent &&
                (bt(e, o.Bs.create(i, 0, i.content.size), "pointer"), !0)
              );
            let s = i.resolve(t);
            for (let r = s.depth + 1; r > 0; r--) {
              let t = r > s.depth ? s.nodeAfter : s.node(r),
                n = s.before(r);
              if (t.inlineContent)
                bt(e, o.Bs.create(i, n + 1, n + 1 + t.content.size), "pointer");
              else {
                if (!o.qv.isSelectable(t)) continue;
                bt(e, o.qv.create(i, n), "pointer");
              }
              return !0;
            }
          })(e, n, i)
      ...
      (at.keydown = (e, t) => {
        ...
        if (
          ...
          if (
            (e.domObserver.selectionChanged(e.domSelectionRange())
              ? e.domObserver.flush()
      ...
      dt.mousedown = (e, t) => {
        ...
        let r = e.posAtCoords(gt(n));
        r &&
          ("singleClick" == s
            ? (e.input.mouseDown && e.input.mouseDown.done(),
              (e.input.mouseDown = new St(e, r, n, !!o)))
            : ("doubleClick" == s ? wt : Dt)(e, r.pos, r.inside, n)
            ? n.preventDefault()
            : ft(e, "pointer"));
      };
      class St {
      ...
      (dt.touchstart = (e) => {
        (e.input.lastTouch = Date.now()), Nt(e), ft(e, "pointer");
      }),
        (dt.touchmove = (e) => {
          (e.input.lastTouch = Date.now()), ft(e, "pointer");
        }),
        (dt.contextmenu = (e) => Nt(e));
      const Mt = V ? 5e3 : -1;
      function xt(e, t) {
      ...
      (dt.copy = at.cut =
        ...
        (at.paste = (e, t) => {
          ...
          o && At(e, Vt(o), o.getData("text/html"), i, n)
            ? n.preventDefault()
            : (function (e, t) {
                if (!e.dom.parentNode) return;
                let n =
                ...
                setTimeout(() => {
                  e.focus(),
                    ...
                    n
                      ? At(e, o.value, null, i, t)
                      : At(e, o.textContent, o.innerHTML, i, t);
                }, 50);
              })(e, n);
        });
      class Rt {
      ...
      (dt.dragstart = (e, t) => {
        ...
        let s,
          r = e.state.selection,
          l = r.empty ? null : e.posAtCoords(gt(n));
        if (
          l &&
          l.pos >= r.from &&
        ...
        (!n.dataTransfer.files.length || !x || k > 120) &&
          ...
          n.dataTransfer.setData(Pt ? "Text" : "text/html", a.innerHTML),
          (n.dataTransfer.effectAllowed = "copyMove"),
          Pt || n.dataTransfer.setData("text/plain", c),
          (e.dragging = new Rt(h, !n[Bt], s));
      }),
        (dt.dragend = (e) => {
          let t = e.dragging;
          window.setTimeout(() => {
        ...
        (at.drop = (e, t) => {
          ...
          a
            ...
            : (a = Qe(
                e,
                Vt(n.dataTransfer),
                Pt ? null : n.dataTransfer.getData("text/html"),
                !1,
                d
              ));
          let c = !(!r || n[Bt]);
      ...
      class zt {
        ...
        map(e, t, n, o) {
          ...
          return s ? null : new Ft(i - n, i - n, this);
        }
        valid() {
          return !0;
        }
          ...
          return (
            ...
            (e instanceof zt &&
              ((this.spec.key && this.spec.key == e.spec.key) ||
                (this.toDOM == e.toDOM && qt(this.spec, e.spec))))
          );
        }
        destroy(e) {
      ...
      class Ft {
        ...
        static widget(e, t, n) {
          return new Ft(e, e, new zt(t, n));
        }
        static inline(e, t, n, o) {
          return new Ft(e, t, new It(n, o));
        }
        static node(e, t, n, o) {
          return new Ft(e, t, new Lt(n, o));
        }
        get spec() {
      ...
      class Ht {
        ...
        static create(e, t) {
          return t.length ? jt(t, e, 0, Kt) : Wt;
        }
        find(e, t, n) {
          let o = [];
          return (
        ...
        map(e, t, n) {
          return this == Wt || 0 == e.maps.length
            ? this
          ...
          e.forEach((e, s) => {
            ...
            if ((r = Gt(t, e, l))) {
              ...
              o[i] == s
                ...
                : o.splice(i, 0, s, s + e.nodeSize, jt(r, e, l + 1, Kt)),
                (i += 3);
            }
          });
          let s = Yt(i ? Ut(t) : t, -n);
        ...
        forChild(e, t) {
          ...
          for (let r = 0; r < this.local.length; r++) {
            let e = this.local[r];
            if (e.from < s && e.to > i && e.type instanceof It) {
        ...
        localsInner(e) {
          ...
          for (let n = 0; n < this.local.length; n++)
            this.local[n].type instanceof It || t.push(this.local[n]);
          return t;
        }
        forEachSet(e) {
          e(this);
      ...
      (Ht.empty = new Ht([], [])), (Ht.removeOverlap = Jt);
      const Wt = Ht.empty;
      class _t {
        constructor(e) {
          this.members = e;
        ...
        forChild(e, t) {
          ...
          for (let o = 0; o < this.members.length; o++) {
            ...
            i != Wt &&
              (i instanceof _t ? (n = n.concat(i.members)) : n.push(i));
          }
          return _t.from(n);
        }
        eq(e) {
      ...
      function Yt(e, t) {
        ...
        for (let o = 0; o < e.length; o++) {
          let i = e[o];
          n.push(new Ft(i.from + t, i.to + t, i.type));
        }
        return n;
      }
      function Gt(e, t, n) {
            ...
            for (let i = n + 1; i < t.length; i++) {
              ...
              if (s.from != o.from) {
                s.from < o.to &&
                  ...
                  Qt(t, i, o.copy(s.from, o.to)));
                break;
              }
              s.to != o.to &&
                (t == e && (t = e.slice()),
                (t[i] = s.copy(s.from, o.to)),
                Qt(t, i + 1, s.copy(o.to, s.to)));
            }
        }
        return t;
      }
        ...
        flush() {
          ...
          if (C && d.length) {
            ...
            if (2 == t.length) {
              ...
              for (let o of t) {
                let t = o.parentNode;
                !t || "LI" != t.nodeName || (n && dn(e, n) == t) || o.remove();
              }
            }
          }
          let a = null;
              ...
              (s > -1 &&
                ...
                (function (e) {
                  ...
                  if (
                    ...
                    if (((e.requiresGeckoHackNode = C), rn)) return;
                    console.warn(
      ...
      function hn(e, t, n, s, r) {
        ...
        if (
          ...
          ((E && e.input.lastIOSEnter > Date.now() - 225) || V) &&
            r.some((e) => 1 == e.nodeType && !cn.test(e.nodeName)) &&
            (!b || b.endA >= b.endB) &&
            e.someProp("handleKeyDown", (t) => t(e, g(13, "Enter"))))
        )
        ...
        if (
          ...
          (function (e, t, n, o, i) {
            if (n - t <= i.pos - o.pos || un(o, !0, !1) < i.pos) return !1;
            let s = e.resolve(t);
            ...
            if (s.parentOffset < s.parent.content.size || !s.parent.isTextblock)
              return !1;
            let r = e.resolve(un(s, !0, !0));
            return (
              !(!r.parent.isTextblock || r.pos > n || un(r, !0, !1) < n) &&
      ...
      class mn {
        constructor(e, t) {
          (this._root = null),
            ...
            (function (e) {
              ...
              T && e.dom.addEventListener("input", () => null), ut(e);
            })(this),
        ...
        updateStateInner(e, t) {
          ...
          let o = this.state,
            i = !1,
            s = !1;
          e.storedMarks && this.composing && (kt(this), (s = !0)),
            (this.state = e);
      ...
      function yn(e) {
        if (e.markCursor) {
          ...
          (t.className = "ProseMirror-separator"),
            ...
            (e.cursorWrapper = {
              dom: t,
              deco: Ft.widget(e.state.selection.from, t, {
                raw: !0,
                marks: e.markCursor,
              }),
            });
