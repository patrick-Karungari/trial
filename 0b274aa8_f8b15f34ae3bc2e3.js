...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [31865],
  {
    922632: function (E, T, R) {
      ...
      var A = R(167606),
        ...
        _ = (E, T, R) =>
          T in E
            ...
            : (E[T] = R),
        e = (E, T) => {
          for (var R in T || (T = {})) L.call(T, R) && _(E, R, T[R]);
          if (N) for (var R of N(T)) C.call(T, R) && _(E, R, T[R]);
          return E;
        },
        D = (E, T) => O(E, I(T)),
        P = {};
      ...
      var M = (E) => E.flatMap(U),
        U = (E) => n(t(E)).map(s),
        s = (E) => E.replace(/ +/g, " ").trim(),
        t = (E) => ({ type: "mandatory_block", items: G(E, 0)[0] }),
        G = (E, T, R) => {
          const A = [];
          for (; E[T]; ) {
            const [S, O] = r(E, T);
        ...
        H = (E, T) => {
          if ("{" === E[T]) return a(E, T + 1);
          if ("[" === E[T]) return B(E, T + 1);
          {
            let R = "";
        ...
        n = (E) => {
          ...
          if ("concatenation" === E.type) return E.items.map(n).reduce(i, [""]);
          if ("mandatory_block" === E.type) return E.items.flatMap(n);
          if ("optional_block" === E.type) return ["", ...E.items.flatMap(n)];
        ...
        o = ((E) => (
          ...
          (E.STRING = "STRING"),
          (E.VARIABLE = "VARIABLE"),
          (E.RESERVED_DATA_TYPE = "RESERVED_DATA_TYPE"),
          (E.RESERVED_PARAMETERIZED_DATA_TYPE =
        ...
        Y = F(1 / 0),
        V = (E) => (T) => T.type === E.type && T.text === E.text,
        W = {
          ARRAY: V({ text: "ARRAY", type: "RESERVED_DATA_TYPE" }),
          BY: V({ text: "BY", type: "RESERVED_KEYWORD" }),
          SET: V({ text: "SET", type: "RESERVED_CLAUSE" }),
          STRUCT: V({ text: "STRUCT", type: "RESERVED_DATA_TYPE" }),
          WINDOW: V({ text: "WINDOW", type: "RESERVED_CLAUSE" }),
          VALUES: V({ text: "VALUES", type: "RESERVED_CLAUSE" }),
        },
        X = (E) =>
          "RESERVED_DATA_TYPE" === E ||
          "RESERVED_KEYWORD" === E ||
          "RESERVED_FUNCTION_NAME" === E ||
          "RESERVED_PHRASE" === E ||
          "RESERVED_CLAUSE" === E ||
          "RESERVED_SELECT" === E ||
          "RESERVED_SET_OPERATION" === E ||
          "RESERVED_JOIN" === E ||
          "ARRAY_KEYWORD" === E ||
          "CASE" === E ||
          "END" === E ||
          ...
          "OR" === E ||
          "XOR" === E,
        p = M(["SELECT [ALL | DISTINCT] [AS STRUCT | AS VALUE]"]),
        l = M([
          "WITH [RECURSIVE]",
          "FROM",
          "WHERE",
        ...
        d = {
          ...
          tokenizerOptions: {
            ...
            postProcess: function (E) {
              return (function (E) {
                let T = Y;
                return E.map((E) =>
                  "OFFSET" === E.text && "[" === T.text
                    ? ((T = E), D(e({}, E), { type: "RESERVED_FUNCTION_NAME" }))
                    : ((T = E), E)
                );
              })(
                (function (E) {
                  ...
                  for (let A = 0; A < E.length; A++) {
                    const S = E[A];
                    if (
                      (W.ARRAY(S) || W.STRUCT(S)) &&
                      "<" === (null == (T = E[A + 1]) ? void 0 : T.text)
                    ) {
                      const T = y(E, A + 1),
                        O = E.slice(A, T + 1);
                      R.push({
                        type: "IDENTIFIER",
                        raw: O.map(h("raw")).join(""),
                        text: O.map(h("text")).join(""),
                        start: S.start,
                      }),
                        (A = T);
                    } else R.push(S);
          ...
          formatOptions: { onelineClauses: m },
        };
      var h = (E) => (T) =>
        "IDENTIFIER" === T.type || "COMMA" === T.type ? T[E] + " " : T[E];
      function y(E, T) {
        let R = 0;
      ...
      var f = M(["SELECT [ALL | DISTINCT]"]),
        ...
        x = M(["UNION [ALL]", "EXCEPT [ALL]", "INTERSECT [ALL]"]),
        $ = M([
          "JOIN",
          "{LEFT | RIGHT | FULL} [OUTER] JOIN",
          "{INNER | CROSS} JOIN",
        ]),
        g = M(["ON DELETE", "ON UPDATE", "SET NULL", "{ROWS | RANGE} BETWEEN"]),
        Q = {
          name: "db2",
          tokenizerOptions: {
            reservedSelect: f,
            reservedClauses: [...J, ...b],
            reservedSetOperations: x,
            reservedJoins: $,
            reservedPhrases: g,
            reservedKeywords: [
              "ACTIVATE",
          ...
          formatOptions: { onelineClauses: b },
        },
        w = M(["SELECT [ALL | DISTINCT]"]),
        Z = M([
          "WITH [RECURSIVE]",
          "INTO",
          "FROM",
        ...
        q = M(["UNION [ALL]", "EXCEPT [ALL]", "INTERSECT [ALL]"]),
        k = M([
          "JOIN",
          "{LEFT | RIGHT | FULL} [OUTER] JOIN",
        ...
        z = M(["ON DELETE", "ON UPDATE", "SET NULL", "{ROWS | RANGE} BETWEEN"]),
        j = {
          name: "db2i",
          tokenizerOptions: {
            reservedSelect: w,
        ...
        OE = M(["{ROWS | RANGE} BETWEEN"]),
        IE = {
          name: "hive",
          tokenizerOptions: {
            reservedSelect: EE,
            reservedClauses: [...TE, ...RE],
          ...
          formatOptions: { onelineClauses: RE },
        };
      function NE(E) {
        return E.map((T, R) => {
          const A = E[R + 1] || Y;
          if (W.SET(T) && "(" === A.text)
            return D(e({}, T), { type: "RESERVED_FUNCTION_NAME" });
          const S = E[R - 1] || Y;
          return W.VALUES(T) && "=" === S.text
            ? D(e({}, T), { type: "RESERVED_FUNCTION_NAME" })
            : T;
        });
      }
      var LE = M(["SELECT [ALL | DISTINCT | DISTINCTROW]"]),
        CE = M([
          "WITH [RECURSIVE]",
          "FROM",
          "WHERE",
        ...
        UE = M(["SELECT [ALL | DISTINCT | DISTINCTROW]"]),
        sE = M([
          "WITH [RECURSIVE]",
          "FROM",
          "WHERE",
        ...
        aE = {
          ...
          formatOptions: { onelineClauses: tE },
        },
        BE = M(["SELECT [ALL | DISTINCT]"]),
        nE = M([
          "WITH",
          "FROM",
          "WHERE",
        ...
        oE = M(["UNION [ALL]", "EXCEPT [ALL]", "INTERSECT [ALL]"]),
        FE = M(["JOIN", "{LEFT | RIGHT} [OUTER] JOIN", "INNER JOIN"]),
        YE = M(["{ROWS | RANGE | GROUPS} BETWEEN"]),
        VE = {
          name: "n1ql",
          tokenizerOptions: {
            reservedSelect: BE,
            reservedClauses: [...nE, ...iE],
          ...
          formatOptions: { onelineClauses: iE },
        },
        WE = M(["SELECT [ALL | DISTINCT | UNIQUE]"]),
        XE = M([
          "WITH",
          "FROM",
          "WHERE",
        ...
        lE = M(["UNION [ALL]", "EXCEPT", "INTERSECT"]),
        mE = M([
          "JOIN",
          "{LEFT | RIGHT | FULL} [OUTER] JOIN",
          "{INNER | CROSS} JOIN",
        ...
        cE = {
          ...
          tokenizerOptions: {
            ...
            postProcess: function (E) {
              ...
              return E.map((E) =>
                W.SET(E) && W.BY(T)
                  ? D(e({}, E), { type: "RESERVED_KEYWORD" })
                  : (X(E.type) && (T = E), E)
              );
            },
          },
          formatOptions: { alwaysDenseOperators: ["@"], onelineClauses: pE },
        };
      var uE = M(["SELECT [ALL | DISTINCT]"]),
        dE = M([
          "WITH [RECURSIVE]",
          "FROM",
          "WHERE",
        ...
        QE = M(["UNION [ALL]", "EXCEPT", "INTERSECT", "MINUS"]),
        wE = M([
          "JOIN",
          "{LEFT | RIGHT | FULL} [OUTER] JOIN",
          "{INNER | CROSS} JOIN",
        ...
        vE = {
          ...
          formatOptions: { alwaysDenseOperators: ["::"], onelineClauses: gE },
        },
        qE = M(["SELECT [ALL | DISTINCT]"]),
        kE = M([
          "WITH",
          "FROM",
          "WHERE",
          ...
          tokenizerOptions: {
            ...
            postProcess: function (E) {
              return E.map((T, R) => {
                const A = E[R - 1] || Y,
                  S = E[R + 1] || Y;
                return W.WINDOW(T) && "OPEN_PAREN" === S.type
                  ? D(e({}, T), { type: "RESERVED_FUNCTION_NAME" })
                  : "ITEMS" !== T.text ||
                    "RESERVED_KEYWORD" !== T.type ||
                    ("COLLECTION" === A.text && "TERMINATED" === S.text)
                  ? T
                  : D(e({}, T), { type: "IDENTIFIER", text: T.raw });
              });
            },
          },
          formatOptions: { onelineClauses: zE },
        };
      var AT = M(["SELECT [ALL | DISTINCT]"]),
        ST = M([
          "WITH [RECURSIVE]",
          "FROM",
          "WHERE",
        ...
        IT = M(["UNION [ALL]", "EXCEPT", "INTERSECT"]),
        NT = M([
          "JOIN",
          "{LEFT | RIGHT | FULL} [OUTER] JOIN",
          "{INNER | CROSS} JOIN",
        ...
        sT = {
          ...
          formatOptions: { onelineClauses: DT },
        },
        tT = M(["SELECT [ALL | DISTINCT]"]),
        GT = M([
          "WITH [RECURSIVE]",
          "FROM",
          "WHERE",
        ...
        BT = M(["{ROWS | RANGE | GROUPS} BETWEEN", "IS [NOT] DISTINCT FROM"]),
        nT = {
          name: "trino",
          tokenizerOptions: {
            reservedSelect: tT,
            reservedClauses: [...GT, ...rT],
          ...
          formatOptions: { onelineClauses: rT },
        },
        iT = M(["SELECT [ALL | DISTINCT]"]),
        oT = M([
          "WITH",
          "INTO",
          "FROM",
        ...
        YT = M(["UNION [ALL]", "EXCEPT", "INTERSECT"]),
        VT = M([
          "JOIN",
          "{LEFT | RIGHT | FULL} [OUTER] JOIN",
          "{INNER | CROSS} JOIN",
        ...
        XT = {
          ...
          formatOptions: { alwaysDenseOperators: ["::"], onelineClauses: FT },
        },
        pT = M(["SELECT [ALL | DISTINCT | DISTINCTROW]"]),
        lT = M([
          "WITH",
          "FROM",
          "WHERE",
        ...
        KT = M(["UNION [ALL | DISTINCT]", "EXCEPT", "INTERSECT", "MINUS"]),
        cT = M([
          "JOIN",
          "{LEFT | RIGHT | FULL} [OUTER] JOIN",
          "{INNER | CROSS} JOIN",
        ...
        JT = M(["UNION [ALL]", "MINUS", "EXCEPT", "INTERSECT"]),
        bT = M([
          "[INNER] JOIN",
          "[NATURAL] {LEFT | RIGHT | FULL} [OUTER] JOIN",
          "{CROSS | NATURAL} JOIN",
        ...
        gT = (E) => E[E.length - 1],
        QT = (E) => E.sort((E, T) => T.length - E.length || E.localeCompare(T)),
        wT = (E) => E.replace(/\s+/gu, " "),
        ZT = (E) => /\n/.test(E),
        vT = (E) => E.replace(/[.*+?^${}()|[\]\\]/gu, "\\$&"),
        qT = /\s+/uy,
        kT = (E) => new RegExp(`(?:${E})`, "uy"),
        zT = (E) =>
          E.split("")
            .map((E) =>
              / /gu.test(E) ? "\\s+" : `[${E.toUpperCase()}${E.toLowerCase()}]`
            )
            .join(""),
        jT = (E, T = []) => {
          const R = "open" === E ? 0 : 1,
            A = ["()", ...T].map((E) => E[R]);
          return kT(A.map(vT).join("|"));
        },
        ER = (E, T = {}) => {
          if (0 === E.length) return /^\b$/u;
          const R = (({ rest: E, dashes: T }) =>
              E || T ? `(?![${E || ""}${T ? "-" : ""}])` : "")(T),
            A = QT(E).map(vT).join("|").replace(/ /gu, "\\s+");
          return new RegExp(`(?:${A})${R}\\b`, "iuy");
        },
        TR = (E, T) => {
          if (!E.length) return;
          const R = E.map(vT).join("|");
          return kT(`(?:${R})(?:${T})`);
        },
        RR = {
          "``": "(?:`[^`]*`)+",
          ...
          "q''": (() => {
            const E = { "<": ">", "[": "]", "(": ")", "{": "}" },
              T = Object.entries(E).map(([E, T]) =>
                "{left}(?:(?!{right}').)*?{right}"
                  .replace(/{left}/g, vT(E))
                  .replace(/{right}/g, vT(T))
              ),
              R = vT(Object.keys(E).join(""));
      ...
      var _R = /\/\*/uy,
        ...
        PR = class {
          ...
          exec(E) {
            let T,
              R = "",
              A = 0;
            if (!(T = this.matchSection(_R, E))) return null;
            for (R += T, A++; A > 0; )
              if ((T = this.matchSection(_R, E))) (R += T), A++;
              else if ((T = this.matchSection(DR, E))) (R += T), A--;
              else {
                if (!(T = this.matchSection(eR, E))) return null;
                R += T;
              }
            return [R];
          }
        ...
        MR = class {
          ...
          tokenize(E, T) {
            const R = [
              ...
              A = new (class {
                ...
                tokenize(E) {
                  ...
                  for (; this.index < this.input.length; ) {
                    ...
                    if (this.index < this.input.length) {
                      ...
                      T.push(D(e({}, R), { precedingWhitespace: E }));
                    }
                  }
                  return T;
                }
                ...
                getWhitespace() {
                  qT.lastIndex = this.index;
                  const E = qT.exec(this.input);
                ...
                match(E) {
                  ...
                  if (T) {
                    ...
                    return (
                      E.key && (A.key = E.key(R)), (this.index += R.length), A
                    );
                  }
                }
              })(R, this.dialectName).tokenize(E);
          ...
          buildRulesBeforeParams(E) {
            ...
            return this.validRules([
              {
                type: "BLOCK_COMMENT",
                regex: E.nestedBlockComments ? new PR() : /(\/\*[^]*?\*\/)/uy,
              },
              {
                type: "LINE_COMMENT",
                regex:
                  ((A = null != (T = E.lineCommentTypes) ? T : ["--"]),
                  new RegExp(
                    `(?:${A.map(vT).join("|")}).*?(?=\r\n|\r|\n|$)`,
                    "uy"
                  )),
              },
              { type: "QUOTED_IDENTIFIER", regex: IR(E.identTypes) },
              {
                type: "NUMBER",
                regex:
              ...
              },
              {
                ...
                regex: ER(
                  null != (R = E.reservedPhrases) ? R : [],
                  E.identChars
                ),
                text: UR,
              },
              { type: "CASE", regex: /CASE\b/iuy, text: UR },
              { type: "END", regex: /END\b/iuy, text: UR },
              { type: "BETWEEN", regex: /BETWEEN\b/iuy, text: UR },
              {
                type: "LIMIT",
                regex: E.reservedClauses.includes("LIMIT")
                  ? /LIMIT\b/iuy
                  : void 0,
                text: UR,
              },
              {
                ...
                regex: ER(E.reservedClauses, E.identChars),
                text: UR,
              },
              {
                type: "RESERVED_SELECT",
                regex: ER(E.reservedSelect, E.identChars),
                text: UR,
              },
              {
                type: "RESERVED_SET_OPERATION",
                regex: ER(E.reservedSetOperations, E.identChars),
                text: UR,
              },
              { type: "WHEN", regex: /WHEN\b/iuy, text: UR },
              { type: "ELSE", regex: /ELSE\b/iuy, text: UR },
              { type: "THEN", regex: /THEN\b/iuy, text: UR },
              {
                type: "RESERVED_JOIN",
                regex: ER(E.reservedJoins, E.identChars),
                text: UR,
              },
              { type: "AND", regex: /AND\b/iuy, text: UR },
              { type: "OR", regex: /OR\b/iuy, text: UR },
              {
                type: "XOR",
              ...
              },
              {
                ...
                regex: ER(E.reservedFunctionNames, E.identChars),
                text: UR,
              },
              {
                type: "RESERVED_DATA_TYPE",
                regex: ER(E.reservedDataTypes, E.identChars),
                text: UR,
              },
              {
                type: "RESERVED_KEYWORD",
                regex: ER(E.reservedKeywords, E.identChars),
                text: UR,
              },
            ]);
          }
            ...
            return this.validRules([
              {
                ...
                regex: E.variableTypes
                  ? ((A = E.variableTypes),
                    kT(
                      A.map((E) => ("regex" in E ? E.regex : AR(E))).join("|")
                    ))
                  : void 0,
              },
              { type: "STRING", regex: IR(E.stringTypes) },
              { type: "IDENTIFIER", regex: NR(E.identChars) },
              { type: "DELIMITER", regex: /[;]/uy },
              { type: "COMMA", regex: /[,]/y },
              { type: "OPEN_PAREN", regex: jT("open", E.extraParens) },
              { type: "CLOSE_PAREN", regex: jT("close", E.extraParens) },
              {
                type: "OPERATOR",
                regex:
                  ((R = [
          ...
          buildParamRules(E, T) {
            ...
            const N = {
              named:
                ...
                (null == (R = E.paramTypes) ? void 0 : R.named) ||
                [],
              quoted:
                (null == T ? void 0 : T.quoted) ||
                (null == (A = E.paramTypes) ? void 0 : A.quoted) ||
                [],
              numbered:
                (null == T ? void 0 : T.numbered) ||
                (null == (S = E.paramTypes) ? void 0 : S.numbered) ||
                [],
              positional:
                "boolean" === typeof (null == T ? void 0 : T.positional)
                  ? T.positional
                  : null == (O = E.paramTypes)
                  ? void 0
                  : O.positional,
              custom:
                ...
                (null == (I = E.paramTypes) ? void 0 : I.custom) ||
                [],
            };
            return this.validRules([
              {
                type: "NAMED_PARAMETER",
                regex: TR(N.named, LR(E.paramChars || E.identChars)),
                key: (E) => E.slice(1),
              },
              {
                type: "QUOTED_PARAMETER",
                regex: TR(N.quoted, SR(E.identTypes)),
                key: (E) =>
                  (({ tokenKey: E, quoteChar: T }) =>
                    E.replace(new RegExp(vT("\\" + T), "gu"), T))({
        ...
        UR = (E) => wT(E.toUpperCase()),
        sR = new Map(),
        tR = (E) => ({
          tokenizer: new MR(E.tokenizerOptions, E.name),
          formatOptions: GR(E.formatOptions),
        }),
        GR = (E) => ({
      ...
      var HR = (E, T, R) => {
          if (X(E.type)) {
            const A = oR(R, T);
            if (A && "." === A.text)
              return D(e({}, E), { type: "IDENTIFIER", text: E.raw });
          }
          return E;
        },
        aR = (E, T, R) => {
          if ("RESERVED_FUNCTION_NAME" === E.type) {
            const A = FR(R, T);
            if (!A || !YR(A)) return D(e({}, E), { type: "RESERVED_KEYWORD" });
          }
          return E;
        },
        BR = (E, T, R) => {
          if ("RESERVED_DATA_TYPE" === E.type) {
            const A = FR(R, T);
            if (A && YR(A))
              return D(e({}, E), { type: "RESERVED_PARAMETERIZED_DATA_TYPE" });
          }
          return E;
        },
        nR = (E, T, R) => {
          if ("IDENTIFIER" === E.type) {
            const A = FR(R, T);
            if (A && VR(A)) return D(e({}, E), { type: "ARRAY_IDENTIFIER" });
          }
          return E;
        },
        iR = (E, T, R) => {
          if ("RESERVED_DATA_TYPE" === E.type) {
            const A = FR(R, T);
            if (A && VR(A)) return D(e({}, E), { type: "ARRAY_KEYWORD" });
          }
          return E;
        },
        oR = (E, T) => FR(E, T, -1),
        FR = (E, T, R = 1) => {
          let A = 1;
          for (; E[T + A * R] && WR(E[T + A * R]); ) A++;
          return E[T + A * R];
        },
        YR = (E) => "OPEN_PAREN" === E.type && "(" === E.text,
        VR = (E) => "OPEN_PAREN" === E.type && "[" === E.text,
        WR = (E) => "BLOCK_COMMENT" === E.type || "LINE_COMMENT" === E.type,
        XR = class {
          constructor(E) {
            (this.tokenize = E),
              (this.index = 0),
      ...
      var lR = new XR((E) => []),
        ...
        cR = (E) => ({ type: "data_type", text: E.text, raw: E.raw }),
        uR = (E, { leading: T, trailing: R }) => (
          (null == T ? void 0 : T.length) &&
            (E = D(e({}, E), { leadingComments: T })),
          (null == R ? void 0 : R.length) &&
            (E = D(e({}, E), { trailingComments: R })),
          E
        ),
        dR = (E, { leading: T, trailing: R }) => {
        ...
        hR = {
          ...
          ParserRules: [
            ...
            },
            {
              ...
              symbols: [
                lR.has("DELIMITER") ? { type: "DELIMITER" } : DELIMITER,
              ],
            },
            {
              name: "statement$subexpression$1",
              symbols: [lR.has("EOF") ? { type: "EOF" } : EOF],
            },
            {
              name: "statement",
            ...
            },
            {
              ...
              symbols: [lR.has("ASTERISK") ? { type: "ASTERISK" } : ASTERISK],
              postprocess: () => ({ type: "all_columns_asterisk" }),
            },
            ...
            },
            {
              ...
              postprocess: ([E, T]) => uR(E, { trailing: T }),
            },
            {
              name: "_expression_with_comments",
              symbols: ["_", "expression"],
              postprocess: ([E, T]) => uR(T, { leading: E }),
            },
            {
            ...
            },
            {
              ...
              postprocess: ([E, T, R]) => ({
                ...
                array: uR(
                  { type: "identifier", quoted: !1, text: E.text },
                  { trailing: T }
                ),
                parenthesis: R,
              }),
            ...
            { name: "property_access$subexpression$1", symbols: ["parameter"] },
            {
              ...
              symbols: [
                "atomic_expression",
                "_",
                lR.has("DOT") ? { type: "DOT" } : DOT,
                "_",
                "property_access$subexpression$1",
              ],
              postprocess: ([E, T, R, A, [S]]) => ({
                type: "property_access",
                object: uR(E, { trailing: T }),
                property: uR(S, { leading: A }),
              }),
            },
            {
              name: "between_predicate",
              symbols: [
                lR.has("BETWEEN") ? { type: "BETWEEN" } : BETWEEN,
                "_",
                "andless_expression_chain",
                "_",
                lR.has("AND") ? { type: "AND" } : AND,
                "_",
                "andless_expression",
              ],
              postprocess: ([E, T, R, A, S, O, I]) => ({
                type: "between_predicate",
                betweenKw: KR(E),
                expr1: dR(R, { leading: T, trailing: A }),
                andKw: KR(S),
                expr2: [uR(I, { leading: O })],
              }),
            },
            {
            ...
            },
            {
              ...
              symbols: [
                lR.has("CASE") ? { type: "CASE" } : CASE,
                "_",
                "case_expression$ebnf$1",
                "case_expression$ebnf$2",
                lR.has("END") ? { type: "END" } : END,
              ],
              postprocess: ([E, T, R, A, S]) => ({
                type: "case_expression",
                caseKw: uR(KR(E), { trailing: T }),
                endKw: KR(S),
                expr: R || [],
                clauses: A,
              }),
            },
            {
              name: "case_clause",
              symbols: [
                lR.has("WHEN") ? { type: "WHEN" } : WHEN,
                "_",
                "expression_chain_",
                lR.has("THEN") ? { type: "THEN" } : THEN,
                "_",
                "expression_chain_",
              ],
              postprocess: ([E, T, R, A, S, O]) => ({
                type: "case_when",
                whenKw: uR(KR(E), { trailing: T }),
                thenKw: uR(KR(A), { trailing: S }),
                condition: R,
                result: O,
              }),
            },
            {
              name: "case_clause",
              symbols: [
                lR.has("ELSE") ? { type: "ELSE" } : ELSE,
                "_",
                "expression_chain_",
              ],
              postprocess: ([E, T, R]) => ({
                type: "case_else",
                elseKw: uR(KR(E), { trailing: T }),
                result: R,
              }),
            },
            {
              name: "comma$subexpression$1",
              symbols: [lR.has("COMMA") ? { type: "COMMA" } : COMMA],
            },
            {
              name: "comma",
              symbols: ["comma$subexpression$1"],
              postprocess: ([[E]]) => ({ type: "comma" }),
            },
            {
            ...
            },
            {
              ...
              postprocess: ([[E]]) => ({ type: "operator", text: E.text }),
            },
            {
              name: "operator$subexpression$1",
              symbols: [lR.has("OPERATOR") ? { type: "OPERATOR" } : OPERATOR],
            },
            {
              name: "operator",
            ...
            },
            {
              ...
              symbols: [
                lR.has("IDENTIFIER") ? { type: "IDENTIFIER" } : IDENTIFIER,
              ],
            },
            {
              name: "identifier$subexpression$1",
              symbols: [
                lR.has("QUOTED_IDENTIFIER")
            ...
            {
              name: "identifier$subexpression$1",
              symbols: [lR.has("VARIABLE") ? { type: "VARIABLE" } : VARIABLE],
            },
            {
              name: "identifier",
            ...
            },
            {
              ...
              symbols: [lR.has("NUMBER") ? { type: "NUMBER" } : NUMBER],
            },
            {
              name: "literal$subexpression$1",
              symbols: [lR.has("STRING") ? { type: "STRING" } : STRING],
            },
            {
              name: "literal",
              symbols: ["literal$subexpression$1"],
              postprocess: ([[E]]) => ({ type: "literal", text: E.text }),
            },
            {
              name: "keyword$subexpression$1",
              symbols: [
                lR.has("RESERVED_KEYWORD")
                  ? { type: "RESERVED_KEYWORD" }
                  : RESERVED_KEYWORD,
              ],
            },
            ...
            },
            {
              name: "data_type",
              symbols: [
                lR.has("RESERVED_PARAMETERIZED_DATA_TYPE")
              ...
              postprocess: ([E, T, R]) => ({
                ...
                dataType: uR(cR(E), { trailing: T }),
                parenthesis: R,
              }),
            },
            {
              name: "logic_operator$subexpression$1",
              symbols: [lR.has("AND") ? { type: "AND" } : AND],
            },
            {
              name: "logic_operator$subexpression$1",
              symbols: [lR.has("OR") ? { type: "OR" } : OR],
            },
            {
              name: "logic_operator$subexpression$1",
              symbols: [lR.has("XOR") ? { type: "XOR" } : XOR],
            },
            {
              name: "logic_operator",
            ...
            },
            {
              ...
              symbols: [lR.has("WHEN") ? { type: "WHEN" } : WHEN],
            },
            {
              name: "other_keyword$subexpression$1",
              symbols: [lR.has("THEN") ? { type: "THEN" } : THEN],
            },
            {
              name: "other_keyword$subexpression$1",
              symbols: [lR.has("ELSE") ? { type: "ELSE" } : ELSE],
            },
            {
              name: "other_keyword$subexpression$1",
              symbols: [lR.has("END") ? { type: "END" } : END],
            },
            {
              name: "other_keyword",
      ...
      var JR = class {
            ...
            for (const T of E)
              switch (T) {
                ...
                case 2:
                  ...
                  break;
                case 3:
                  this.trimHorizontalWhitespace(), this.addNewline(3);
                  break;
                case 4:
                  this.trimHorizontalWhitespace(), this.addNewline(4);
                  break;
                case 5:
                  this.addIndentation();
                  break;
          ...
          trimHorizontalWhitespace() {
            for (; bR(gT(this.items)); ) this.items.pop();
          }
          trimWhitespace() {
            for (; xR(gT(this.items)); ) this.items.pop();
          }
          addNewline(E) {
            if (this.items.length > 0)
              switch (gT(this.items)) {
                case 3:
      ...
      function $R(E, T) {
        ...
        let R = [];
        return (
          E.length >= 10 && E.includes(" ") && ([E, ...R] = E.split(" ")),
        ...
        wR = class {
          ...
          decreaseTopLevel() {
            this.indentTypes.length > 0 &&
              gT(this.indentTypes) === QR &&
              this.indentTypes.pop();
          }
          decreaseBlockLevel() {
            for (; this.indentTypes.length > 0; ) {
              if (this.indentTypes.pop() !== QR) break;
            }
          }
        },
        ZR = class extends JR {
      ...
      function kR(E) {
        ...
        for (const A of T)
          if (A in E) throw new qR(`${A} config is no more supported.`);
        ...
        return (
          E.params &&
            !((R = E.params) instanceof Array ? R : Object.values(R)).every(
              (E) => "string" === typeof E
            ) &&
            console.warn(
      ...
      var zR = {
        ...
        TA = (E, T = {}) => {
          if ("string" === typeof T.language && !jR.includes(T.language))
            throw new qR(`Unsupported SQL dialect: ${T.language}`);
          const R = zR[T.language || "sql"];
          return RA(E, D(e({}, T), { dialect: P[R] }));
        },
        RA = (E, T) => {
          var R = T,
            { dialect: A } = R,
            S = ((E, T) => {
              ...
              if (null != E && N)
                for (var A of N(E))
                  T.indexOf(A) < 0 && C.call(E, A) && (R[A] = E[A]);
              return R;
            })(R, ["dialect"]);
          if ("string" !== typeof E)
            throw new Error(
              "Invalid query argument. Expected string, instead got " + typeof E
            );
          const O = kR(e(e({}, EA), S));
          return new (class {
            constructor(E, T) {
            ...
            parse(E) {
              return (function (E) {
                ...
                const R = new XR((R) => {
                    return [
                      ...((A = E.tokenize(R, T)),
                      A.map(HR).map(aR).map(BR).map(nR).map(iR)),
                      F(R.length),
                    ];
                    var A;
                  }),
                  A = new yR(fR.fromCompiled(hR), { lexer: R });
                return {
                  parse: (E, R) => {
                    T = R;
            ...
            formatStatement(E) {
              const T = new (class E {
                ...
                formatParenthesis(E) {
                  ...
                  T
                    ? (this.layout.add(E.openParen),
                      ...
                      this.layout.add(1, E.closeParen, 0))
                    : (this.layout.add(E.openParen, 3),
                      rR(this.cfg)
                        ? (this.layout.add(5),
                      ...
                      this.layout.add(3, 5, E.closeParen, 0));
                }
                formatBetweenPredicate(E) {
                  this.layout.add(this.showKw(E.betweenKw), 0),
                    (this.layout = this.formatSubExpression(E.expr1)),
                    this.layout.add(1, 0, this.showNonTabularKw(E.andKw), 0),
                ...
                formatClauseInIndentedStyle(E) {
                  this.layout.add(3, 5, this.showKw(E.nameKw), 3),
                ...
                formatClauseInOnelineStyle(E) {
                  this.layout.add(3, 5, this.showKw(E.nameKw), 0),
                    (this.layout = this.formatSubExpression(E.children));
                }
                ...
                formatLimitClause(E) {
                  this.withComments(E.limitKw, () => {
                    this.layout.add(3, 5, this.showKw(E.limitKw));
                  }),
                    this.layout.indentation.increaseTopLevel(),
                    rR(this.cfg) ? this.layout.add(0) : this.layout.add(3, 5),
                    E.offset
                ...
                formatLiteral(E) {
                  this.layout.add(E.text, 0);
                }
                formatIdentifier(E) {
                  this.layout.add(this.showIdentifier(E), 0);
                }
                formatParameter(E) {
                  this.layout.add(this.params.get(E), 0);
                }
                formatOperator({ text: E }) {
                  ...
                  this.dialectCfg.alwaysDenseOperators.includes(E)
                    ? this.layout.add(1, E)
                    : ":" === E
                    ? this.layout.add(1, E, 0)
                    : this.layout.add(E, 0);
                }
                formatComma(E) {
                  this.inline
                    ? this.layout.add(1, ",", 0)
                    : this.layout.add(1, ",", 3, 5);
                }
                withComments(E, T) {
                  this.formatComments(E.leadingComments),
                    T(),
                ...
                formatLineComment(E) {
                  ZT(E.precedingWhitespace || "")
                    ? this.layout.add(3, 5, E.text, 4, 5)
                    : this.layout.getLayoutItems().length > 0
                    ? this.layout.add(2, 0, E.text, 4, 5)
                    : this.layout.add(E.text, 4, 5);
                }
                formatBlockComment(E) {
                  this.isMultilineBlockComment(E)
                    ? (this.splitBlockComment(E.text).forEach((E) => {
                        this.layout.add(3, 5, E);
                      }),
                      this.layout.add(3, 5))
                    : this.layout.add(E.text, 0);
                }
                isMultilineBlockComment(E) {
                  return ZT(E.text) || ZT(E.precedingWhitespace || "");
                }
                isDocComment(E) {
                  const T = E.split(/\n/);
                  return (
                ...
                formatInlineExpression(T) {
                  ...
                  try {
                    return new E({
                      ...
                      dialectCfg: this.dialectCfg,
                      params: this.params,
                      layout: new ZR(this.cfg.expressionWidth),
                      inline: !0,
                    }).format(T);
                  } catch (A) {
                    if (A instanceof vR)
                      return void this.params.setPositionalParameterIndex(R);
                    throw A;
                  }
                }
                formatKeywordNode(E) {
                  ...
                  "before" === this.cfg.logicalOperatorNewline
                    ? rR(this.cfg)
                      ? (this.layout.indentation.decreaseTopLevel(),
                        ...
                        this.layout.indentation.increaseTopLevel())
                      : this.layout.add(3, 5, this.showKw(E), 0)
                    : this.layout.add(this.showKw(E), 3, 5);
                }
                formatDataType(E) {
                  this.layout.add(this.showDataType(E), 0);
                }
                showKw(E) {
                  return gR(E.tokenType)
                    ? $R(this.showNonTabularKw(E), this.cfg.indentStyle)
                ...
                showFunctionKw(E) {
                  return gR(E.tokenType)
                    ? $R(this.showNonTabularFunctionKw(E), this.cfg.indentStyle)
