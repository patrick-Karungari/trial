    ...
    176905: function (e, t, n) {
        ...
        for (let r = n || e.dom; r; r = l(r)) {
          ...
          if (
            (t.top < l.top + z(o, "top")
              ...
              : t.bottom > l.bottom - z(o, "bottom") &&
                (a =
                  t.bottom - t.top > l.bottom - l.top
                    ? t.top + z(i, "top") - l.top
                    : t.bottom - l.bottom + z(i, "bottom")),
            t.left < l.left + z(o, "left")
              ? (d = -(l.left - t.left + z(i, "left")))
              : t.right > l.right - z(o, "right") &&
                (d = t.right - l.right + z(i, "right")),
            d || a)
          )
      ...
      function H(e, t) {
        let n,
          ...
          d = t.top,
          c = t.top;
        for (let h = e.firstChild, f = 0; h; h = h.nextSibling, f++) {
          let e;
          ...
          for (let a = 0; a < e.length; a++) {
            let u = e[a];
            if (u.top <= d && u.bottom >= c) {
              (d = Math.max(u.bottom, d)), (c = Math.min(u.top, c));
              let e =
                u.left > t.left
                  ? u.left - t.left
                  : u.right < t.left
              ...
              if (e < r) {
                (n = h),
                  ...
                  1 == h.nodeType &&
                    e &&
                    (l = f + (t.left >= (u.left + u.right) / 2 ? 1 : 0));
                continue;
              }
            } else
              u.top > t.top &&
      ...
      function Y(e, t) {
            ...
            if (e.caretPositionFromPoint)
              try {
                ...
                if (o)
                  return {
                    node: o.offsetNode,
                    offset: Math.min(u(o.offsetNode), o.offset),
                  };
              } catch (o) {}
            if (e.caretRangeFromPoint) {
              ...
              if (o)
                return {
                  ...
                  offset: Math.min(u(o.startContainer), o.startOffset),
                };
            }
          })(o, t.left, t.top);
        s && ({ node: n, offset: i } = s);
        ...
        if (T) for (let c = d; n && c; c = l(c)) c.draggable && (n = void 0);
        if (
          ((d = (function (e, t) {
            let n = e.parentNode;
            return n &&
                  ...
                  for (let s = t, r = !1; s != e.dom; ) {
                    ...
                    if (
                      ...
                      if (
                        (t.node.isBlock &&
                          t.parent &&
                          ((!r && e.left > o.left) || e.top > o.top
                            ? (i = t.posBefore)
                            : ((!r && e.right < o.left) || e.bottom < o.top) &&
                              (i = t.posAfter),
                          (r = !0)),
        ...
        return { pos: r, inside: a ? a.posAtStart - a.border : -1 };
      }
      function G(e) {
              ...
              "up" == n || "down" == n
                ...
                : (function (e, t, n) {
                    ...
                    let i = o.parentOffset,
                      ...
                      l = e.domSelection();
                    return l
                      ? ee.test(o.parent.textContent) && l.modify
                        ? Z(e, t, () => {
                            let {
                                focusNode: t,
                                focusOffset: i,
                            ...
                            return null != d && (l.caretBidiLevel = d), f;
                          })
                        : "left" == n || "backward" == n
                        ? s
                        : r
      ...
      class se {
        ...
        domFromPos(e, t) {
          ...
          if (i)
            return this.children[o].domFromPos(i - this.children[o].border, t);
          for (
            ;
            o &&
            !(n = this.children[o - 1]).size &&
            n instanceof re &&
            n.side >= 0;
            o--
          );
          if (t <= 0) {
            ...
            for (
              ;
              (e = o ? this.children[o - 1] : null),
                e && e.dom.parentNode != this.contentDOM;
              o--, n = !1
            );
            return e && t && n && !e.border && !e.domAtom
          ...
          }
          {
            ...
            for (
              ;
              (e = o < this.children.length ? this.children[o] : null),
                e && e.dom.parentNode != this.contentDOM;
              o++, n = !1
            );
            return e && n && !e.border && !e.domAtom
              ? e.domFromPos(0, t)
              : {
        ...
        setSelection(e, t, n, o = !1) {
          ...
          for (let r = 0, c = 0; r < this.children.length; r++) {
            let l = this.children[r],
              d = c + l.size;
            if (i > c && s < d)
              return l.setSelection(e - c - l.border, t - c - l.border, n, o);
            c = d;
          }
          ...
          if ((a.extend || e == t) && !h) {
            ...
            try {
              e != t && a.extend(d.node, d.offset), (f = !0);
            } catch (u) {}
          }
          if (!f) {
            if (e > t) {
      ...
      class de extends se {
        constructor(e, t, n, o, i) {
          super(e, [], n, o), (this.mark = t), (this.spec = i);
        }
        static create(e, t, n, o) {
          ...
          return (
            ...
            new de(e, t, r.dom, r.contentDOM || r.dom, r)
          );
        }
        parseRule() {
      ...
      class ae extends se {
        ...
        static create(e, t, n, o, s, r) {
          let l,
            ...
            a =
              ...
              d(
                ...
                s,
                () =>
                  l ? (l.parent ? l.parent.posBeforeChild(l) : void 0) : r,
                n,
                o
              ),
            c = a && a.dom,
          ...
          return (
            (c = we(c, n, t)),
            a
              ? (l = new ue(e, t, n, o, c, h || null, f, a, s, r + 1))
              : t.isText
              ? new he(e, t, n, o, c, f, s)
              : new ae(e, t, n, o, c, h || null, f, s, r + 1)
          );
        }
        parseRule() {
        ...
        updateChildren(e, t) {
          ...
          !(function (e, t, n, o) {
            ...
            (d.changed || 2 == this.dirty) &&
              ...
              pe(this.contentDOM, this.children, e),
              E &&
                (function (e) {
        ...
        protectLocalComposition(e, { node: t, pos: n, text: o }) {
          ...
          e.input.compositionNodes.push(s),
            (this.children = Ce(this.children, n, n + o.length, e, s));
        }
        update(e, t, n, o) {
          return (
      ...
      function be(e, t, n, o) {
        ...
        for (let s = 0; s < o.length; s++) {
          ...
          if (s) {
            let n;
            (r &&
              r.nodeName == t.nodeName &&
              i != e &&
              (n = i.parentNode) &&
              n.nodeName.toLowerCase() == t.nodeName) ||
              ((n = document.createElement(t.nodeName)),
              (n.pmIsDeco = !0),
              n.appendChild(i),
              (r = ge[0])),
              (i = n);
      ...
      class Oe {
        ...
        findNodeMatch(e, t, n, o) {
          ...
          if (
            ...
            for (
              let r = this.index, l = Math.min(this.top.children.length, r + 5);
              r < l;
              r++
            ) {
          ...
          return (
            !(s < 0) && (this.destroyBetween(this.index, s), this.index++, !0)
          );
        }
        ...
        updateNextNode(e, t, n, o, i, s) {
          for (let r = this.index; r < this.top.children.length; r++) {
            ...
            if (l instanceof ae) {
              ...
              if (!h && (a = this.recreateWrapper(l, e, t, n, o, s)))
                return (
                  this.destroyBetween(this.index, r),
                  (this.top.children[this.index] = a),
                  a.contentDOM &&
                    ((a.dirty = 2), a.updateChildren(o, s + 1), (a.dirty = 0)),
                  (this.changed = !0),
                  this.index++,
                  !0
                );
        ...
        recreateWrapper(e, t, n, o, i, s) {
          ...
          if (r.contentDOM) {
            (r.children = e.children), (e.children = []);
      ...
      function Me(e, t = null) {
        ...
        if (m(n)) {
          ...
          if (
            ...
            if (t < 0) return null;
            ([a, d] = o == e.state.selection.anchor ? [o, t] : [t, o]),
              (h = i.resolve(d));
          ...
          if ((e.domObserver.disconnectSelection(), e.cursorWrapper))
            !(function (e) {
              ...
              let o = e.cursorWrapper.dom,
                i = "IMG" == o.nodeName;
              i ? n.setStart(o.parentNode, r(o) + 1) : n.setStart(o, 0);
              n.collapse(!0),
                t.removeAllRanges(),
                t.addRange(n),
                !i &&
            ...
            !Te ||
              ...
              n.empty || n.$from.parent.inlineContent || (s = Ee(e, n.to))),
              e.docView.setSelection(r, l, e.root, t),
              Te && (i && Ae(i), s && Ae(s)),
              n.visible
      ...
      function Fe(e, t, n) {
        ...
        if (!(i instanceof o.Bs)) {
          if (i instanceof o.qv && i.node.isInline)
            return Le(e, new o.Bs(t > 0 ? i.$to : i.$from));
          {
            let n = Ie(e.state, t);
            return !!n && Le(e, n);
          }
        ...
        if (n.indexOf("s") > -1) {
          ...
          return Le(e, new o.Bs(i.$anchor, r));
        }
        if (!i.empty) return !1;
        ...
        if (!(P && n.indexOf("m") > -1)) {
          ...
          return (
            !!(r.isAtom || ((n = e.docView.descAt(l)) && !n.contentDOM)) &&
            (o.qv.isSelectable(r)
              ? Le(
                  e,
                  new o.qv(t < 0 ? e.state.doc.resolve(s.pos - r.nodeSize) : s)
                )
              : !!R &&
                Le(
                  e,
                  new o.Bs(e.state.doc.resolve(t < 0 ? l : l + r.nodeSize))
                ))
          );
        }
      }
              ...
              for (;;)
                if (o < l) {
                  ...
                  if (We(n)) break;
                  {
                    let t = n.nextSibling;
                    for (; t && Ke(t, 1); )
                      (i = t.parentNode), (s = r(t) + 1), (t = t.nextSibling);
                    if (t) (n = t), (o = 0), (l = $e(n));
                    else {
                      if (((n = n.parentNode), n == e.dom)) break;
                      o = l = 0;
      ...
      function Xe(e, t) {
        ...
        if (8 == n || (P && 72 == n && "c" == o)) return Ue(e, -1) || He(e, -1);
        if ((46 == n && !t.shiftKey) || (P && 68 == n && "c" == o))
          return Ue(e, 1) || He(e, 1);
        if (13 == n || 27 == n) return !0;
        if (37 == n || (P && 66 == n && "c" == o)) {
          let t =
            37 == n ? ("ltr" == Ye(e, e.state.selection.from) ? -1 : 1) : -1;
          return Fe(e, t, o) || He(e, t);
        }
        if (39 == n || (P && 70 == n && "c" == o)) {
          let t =
      ...
      function Je(e, t) {
        ...
        let c,
          h = a.firstChild,
          f = 0;
        for (; h && 1 == h.nodeType && (c = st[h.nodeName.toLowerCase()]); ) {
            ...
            (r = (function (e) {
              ...
              if (
                ((o.innerHTML = (function (e) {
                  ...
                  if (!t) return e;
                  dt ||
                    (dt = t.createPolicy("ProseMirrorClipboard", {
                      createHTML: (e) => e,
                    }));
                  return dt.createHTML(e);
                })(e)),
                n)
              )
                for (let s = 0; s < n.length; s++)
                  o = o.querySelector(n[s]) || o;
              return o;
            })(n)),
            R &&
              (function (e) {
          ...
          ((l = i.p2.maxOpen(
            (function (e, t) {
              ...
              for (let n = t.depth; n >= 0; n--) {
                let o,
                  s = t.node(n).contentMatchAt(t.index(n)),
                  r = [];
                if (
                  (e.forEach((e) => {
                    if (!r) return;
                    let t,
                      n = s.findWrapping(e.type);
                    if (!n) return (r = null);
                    if (
                      (t =
                        r.length && o.length && tt(n, o, e, r[r.length - 1], 0))
                    )
                      r[r.length - 1] = t;
                    else {
                      r.length &&
                        (r[r.length - 1] = nt(r[r.length - 1], o.length));
                      let t = et(e, n);
      ...
      function tt(e, t, n, o, s) {
        if (s < e.length && s < t.length && e[s] == t[s]) {
          let r = tt(e, t, n, o.lastChild, s + 1);
          if (r) return o.copy(o.content.replaceChild(o.childCount - 1, r));
          if (
            o
              .contentMatchAt(o.childCount)
              .matchType(s == e.length - 1 ? n.type : e[s + 1])
          )
            return o.copy(o.content.append(i.HY.from(et(n, e, s + 1))));
        }
      }
      function nt(e, t) {
        if (0 == t) return e;
          ...
          for (let n in t)
            e.input.eventHandlers[n] ||
              e.dom.addEventListener(
                n,
                (e.input.eventHandlers[n] = (t) => mt(e, t))
              );
        });
      }
      function mt(e, t) {
        ...
        return (
          ...
          (s
            ? (function (e, t) {
                ...
                for (let l = r.depth + 1; l > 0; l--) {
                  ...
                  if (o.qv.isSelectable(e)) {
                    i =
                      ...
                      s.$from.depth > 0 &&
                      l >= s.$from.depth &&
                      r.before(s.$from.depth + 1) == s.$from.pos
                        ? r.before(s.$from.depth)
                        : r.before(l);
                    break;
                  }
                }
                return (
                  null != i &&
                  (vt(e, o.qv.create(e.state.doc, i), "pointer"), !0)
                );
              })(e, n)
            : (function (e, t) {
                if (-1 == t) return !1;
      ...
      function Dt(e, t, n, o) {
        return (
          bt(e, "handleDoubleClickOn", t, n, o) ||
          e.someProp("handleDoubleClick", (n) => n(e, t, o))
        );
      }
      function Nt(e, t, n, i) {
        return (
          bt(e, "handleTripleClickOn", t, n, i) ||
          ...
          (function (e, t, n) {
            ...
            if (-1 == t)
              return (
                !!i.inlineContent &&
                (vt(e, o.Bs.create(i, 0, i.content.size), "pointer"), !0)
              );
            let s = i.resolve(t);
            for (let r = s.depth + 1; r > 0; r--) {
              let t = r > s.depth ? s.nodeAfter : s.node(r),
                n = s.before(r);
              if (t.inlineContent)
                vt(e, o.Bs.create(i, n + 1, n + 1 + t.content.size), "pointer");
              else {
        ...
        r &&
          ("singleClick" == s
            ? (e.input.mouseDown && e.input.mouseDown.done(),
              (e.input.mouseDown = new Ct(e, r, n, !!o)))
            : ("doubleClick" == s ? Dt : Nt)(e, r.pos, r.inside, n)
            ? n.preventDefault()
            : ut(e, "pointer"));
      };
      class Ct {
        ...
        up(e) {
          ...
          this.view.state.doc != this.startDoc &&
            (t = this.view.posAtCoords(yt(e))),
            this.updateAllowDefault(e),
            this.allowDefault || !t
              ? ut(this.view, "pointer")
              : wt(this.view, t.pos, t.inside, e, this.selectNode)
              ? e.preventDefault()
              : 0 == e.button &&
                (this.flushed ||
      ...
      (at.touchstart = (e) => {
        (e.input.lastTouch = Date.now()), Ot(e), ut(e, "pointer");
      }),
        (at.touchmove = (e) => {
      ...
      function kt(e, t) {
        clearTimeout(e.input.composingTimeout),
          t > -1 && (e.input.composingTimeout = setTimeout(() => Pt(e), t));
      }
      function Tt(e) {
        for (
          e.composing &&
        ...
        let n = (function (e, t) {
            for (;;) {
              ...
              if (1 == e.nodeType && t > 0) {
                ...
                if (!e.parentNode || p(e)) return null;
      ...
      const At = (O && S < 15) || (E && B < 604);
      function Vt(e, t, n, o, s) {
        let r = Qe(e, t, n, o, e.state.selection.$from);
      ...
      (at.copy = ct.cut =
        ...
        (ct.paste = (e, t) => {
          ...
          o && Vt(e, Rt(o), o.getData("text/html"), i, n)
            ? n.preventDefault()
            : (function (e, t) {
                if (!e.dom.parentNode) return;
                let n =
                ...
                setTimeout(() => {
                  e.focus(),
                    ...
                    n
                      ? Vt(e, o.value, null, i, t)
                      : Vt(e, o.textContent, o.innerHTML, i, t);
                }, 50);
              })(e, n);
        });
      class Bt {
      ...
      (at.dragstart = (e, t) => {
        ...
        let s,
          r = e.state.selection,
          l = r.empty ? null : e.posAtCoords(yt(n));
        if (
          l &&
          l.pos >= r.from &&
          l.pos <= (r instanceof o.qv ? r.to - 1 : r.to)
        );
        else if (i && i.mightDrag)
          s = o.qv.create(e.state.doc, i.mightDrag.pos);
        else if (n.target && 1 == n.target.nodeType) {
          let t = e.docView.nearestDesc(n.target, !0);
          t &&
            t.node.type.spec.draggable &&
            t != e.docView &&
            (s = o.qv.create(e.state.doc, t.posBefore));
        }
        let d = (s || e.state.selection).content(),
          { dom: a, text: c, slice: h } = Je(e, d);
        (!n.dataTransfer.files.length || !x || k > 120) &&
        ...
        (ct.drop = (e, t) => {
          ...
          let c = !(!r || n[qt]);
          if (e.someProp("handleDrop", (t) => t(e, n, a || i.p2.empty, c)))
            return void n.preventDefault();
          if (!a) return;
          n.preventDefault();
          ...
          if (
            (p
              ? f.replaceRangeWith(u, u, a.content.firstChild)
              : f.replaceRange(u, u, a),
            f.doc.eq(m))
          )
            return;
          ...
          if (
            p &&
            o.qv.isSelectable(a.content.firstChild) &&
            g.nodeAfter &&
            g.nodeAfter.sameMarkup(a.content.firstChild)
          )
            f.setSelection(new o.qv(g));
          else {
            let t = f.mapping.map(h);
            f.mapping.maps[f.mapping.maps.length - 1].forEach(
              (e, n, o, i) => (t = i)
            ),
              f.setSelection(Be(e, g, f.doc.resolve(t)));
          }
      ...
      class It {
        ...
        map(e, t, n, o) {
          ...
          return s ? null : new $t(i - n, i - n, this);
        }
        valid() {
          return !0;
        }
      ...
      class Lt {
        ...
        map(e, t, n, o) {
          ...
          return i >= s ? null : new $t(i, s, this);
        }
        valid(e, t) {
          return t.from < t.to;
        }
      ...
      class $t {
        ...
        static widget(e, t, n) {
          return new $t(e, e, new It(t, n));
        }
        static inline(e, t, n, o) {
          return new $t(e, t, new Lt(n, o));
        }
        static node(e, t, n, o) {
          return new $t(e, t, new Ft(n, o));
        }
        get spec() {
      ...
      class Wt {
        ...
        static create(e, t) {
          return t.length ? Xt(t, e, 0, Ht) : _t;
        }
        find(e, t, n) {
          let o = [];
          return (
          ...
          return this.children.length
            ? (function (e, t, n, o, i, s, r) {
                ...
                for (let a = 0, c = s; a < n.maps.length; a++) {
                  let e = 0;
                  n.maps[a].forEach((t, n, o, i) => {
                    let s = i - o - (n - t);
                    for (let r = 0; r < l.length; r += 3) {
                      let o = l[r + 1];
                      if (o < 0 || t > o + c - e) continue;
                      let i = l[r] + c - e;
                      n >= i
                        ? (l[r + 1] = t <= i ? -2 : -1)
                        : t >= c && s && ((l[r] += s), (l[r + 1] += s));
                ...
                for (let a = 0; a < l.length; a += 3)
                  if (l[a + 1] < 0) {
                    ...
                    let h = n.map(e[a + 1] + s, -1) - i,
                      { index: f, offset: u } = o.content.findIndex(c),
                      p = o.maybeChild(f);
                    if (p && u == c && u + p.nodeSize == h) {
                      let o = l[a + 2].mapInner(n, p, t + 1, e[a] + s + 1, r);
                      o != _t
                        ? ((l[a] = c), (l[a + 1] = h), (l[a + 2] = o))
                        : ((l[a + 1] = -2), (d = !0));
                    } else d = !0;
                  }
                if (d) {
          ...
          e.forEach((e, s) => {
            ...
            if ((r = Ut(t, e, l))) {
              for (o || (o = this.children.slice()); i < o.length && o[i] < s; )
                i += 3;
              o[i] == s
                ? (o[i + 2] = o[i + 2].addInner(e, r, l + 1))
                : o.splice(i, 0, s, s + e.nodeSize, Xt(r, e, l + 1, Ht)),
                (i += 3);
            }
          });
          let s = Gt(i ? jt(t) : t, -n);
          for (let r = 0; r < s.length; r++)
            s[r].type.valid(e, s[r]) || s.splice(r--, 1);
          return new Wt(
            s.length ? this.local.concat(s).sort(Jt) : this.local,
            o || this.children
          );
        }
        remove(e) {
        ...
        forChild(e, t) {
          ...
          for (let r = 0; r < this.local.length; r++) {
            let e = this.local[r];
            if (e.from < s && e.to > i && e.type instanceof Lt) {
          ...
          if (o) {
            let e = new Wt(o.sort(Jt), Kt);
            return n ? new Yt([e, n]) : e;
          }
          return n || _t;
        }
        eq(e) {
        ...
        locals(e) {
          return Qt(this.localsInner(e));
        }
        localsInner(e) {
          if (this == _t) return Kt;
          if (e.inlineContent || !this.local.some(Lt.is)) return this.local;
          let t = [];
          for (let n = 0; n < this.local.length; n++)
            this.local[n].type instanceof Lt || t.push(this.local[n]);
          return t;
        }
        forEachSet(e) {
          e(this);
      ...
      (Wt.empty = new Wt([], [])), (Wt.removeOverlap = Qt);
      const _t = Wt.empty;
      class Yt {
        constructor(e) {
          this.members = e;
        ...
        map(e, t) {
          const n = this.members.map((n) => n.map(e, t, Ht));
          return Yt.from(n);
        }
        forChild(e, t) {
          if (t.isLeaf) return Wt.empty;
          ...
          for (let o = 0; o < this.members.length; o++) {
            ...
            i != _t &&
              (i instanceof Yt ? (n = n.concat(i.members)) : n.push(i));
          }
          return Yt.from(n);
        }
        eq(e) {
          if (!(e instanceof Yt) || e.members.length != this.members.length)
            return !1;
      ...
      function Gt(e, t) {
        ...
        for (let o = 0; o < e.length; o++) {
          let i = e[o];
          n.push(new $t(i.from + t, i.to + t, i.type));
        }
        return n;
      }
      function Ut(e, t, n) {
      ...
      function Xt(e, t, n, o) {
        ...
        t.forEach((t, r) => {
          ...
          if (l) {
            s = !0;
            let e = Xt(l, t, n + r + 1, o);
            e != _t && i.push(r, r + t.nodeSize, e);
          }
        });
        let r = Gt(s ? jt(e) : e, -n).sort(Jt);
        for (let l = 0; l < r.length; l++)
          r[l].type.valid(t, r[l]) ||
            (o.onRemove && o.onRemove(r[l].spec), r.splice(l--, 1));
        return r.length || i.length ? new Wt(r, i) : _t;
      }
      function Jt(e, t) {
            ...
            for (let i = n + 1; i < t.length; i++) {
              ...
              if (s.from != o.from) {
                s.from < o.to &&
                  ...
                  Zt(t, i, o.copy(s.from, o.to)));
                break;
              }
              s.to != o.to &&
                (t == e && (t = e.slice()),
                (t[i] = s.copy(s.from, o.to)),
                Zt(t, i + 1, s.copy(o.to, s.to)));
            }
        }
        return t;
      }
        ...
        flush() {
          ...
          if (e.editable)
            for (let o = 0; o < t.length; o++) {
              ...
              e &&
                ((s = s < 0 ? e.from : Math.min(e.from, s)),
                (r = r < 0 ? e.to : Math.max(e.to, r)),
                e.typeOver && (l = !0));
            }
          if (C && d.length) {
            ...
            if (2 == t.length) {
              ...
              for (let o of t) {
                let t = o.parentNode;
                !t || "LI" != t.nodeName || (n && an(e, n) == t) || o.remove();
              }
            }
          }
          let a = null;
              ...
              (s > -1 &&
                ...
                (function (e) {
                  ...
                  if (
                    ...
                    if (((e.requiresGeckoHackNode = C), ln)) return;
                    console.warn(
      ...
      function dn(e, t) {
        ...
        return (
          c(r.node, r.offset, i, s) && ([n, o, i, s] = [i, s, n, o]),
      ...
      function fn(e, t, n, s, r) {
        ...
        let b = (function (e, t, n, o, i) {
          ...
          if (r < s && e.size < t.size) {
            ...
            (s -= t),
              s &&
                s < e.size &&
                mn(e.textBetween(s - 1, s + 1)) &&
                (s += t ? 1 : -1),
              (r = s + (r - l)),
              (l = s);
          }
          return { start: s, endA: r, endB: l };
        })(y.content, u.doc.content, u.from, c, h);
        if (
          (b && e.input.domChangeCount++,
          ((E && e.input.lastIOSEnter > Date.now() - 225) || V) &&
            r.some((e) => 1 == e.nodeType && !hn.test(e.nodeName)) &&
            (!b || b.endA >= b.endB) &&
            e.someProp("handleKeyDown", (t) => t(e, g(13, "Enter"))))
        )
        ...
        e.state.selection.from < e.state.selection.to &&
          ...
          O &&
            ...
            b.start > u.from &&
            " \xa0" ==
              u.doc.textBetween(b.start - u.from - 1, b.start - u.from + 1) &&
            (b.start--, b.endA--, b.endB--);
        let v,
          w = u.doc.resolveNoCache(b.start - u.from),
          D = u.doc.resolveNoCache(b.endB - u.from),
          N = p.resolve(b.start),
          C = w.sameParent(D) && w.parent.inlineContent && N.end() >= b.endA;
        if (
          ((E &&
            e.input.lastIOSEnter > Date.now() - 225 &&
            (!C || r.some((e) => "DIV" == e.nodeName || "P" == e.nodeName))) ||
            (!C &&
              w.pos < u.doc.content.size &&
              !w.sameParent(D) &&
              (v = o.Y1.findFrom(u.doc.resolve(w.pos + 1), 1, !0)) &&
              v.head == D.pos)) &&
          e.someProp("handleKeyDown", (t) => t(e, g(13, "Enter")))
        )
          return void (e.input.lastIOSEnter = 0);
        if (
          e.state.selection.anchor > b.start &&
          (function (e, t, n, o, i) {
            ...
            if (s.parentOffset < s.parent.content.size || !s.parent.isTextblock)
              return !1;
            let r = e.resolve(pn(s, !0, !0));
            return (
              !(!r.parent.isTextblock || r.pos > n || pn(r, !0, !1) < n) &&
              o.parent.content.cut(o.parentOffset).eq(r.parent.content)
            );
          })(p, b.start, b.endA, w, D) &&
          e.someProp("handleKeyDown", (t) => t(e, g(8, "Backspace")))
        )
          return void (V && x && e.domObserver.suppressSelectionUpdates());
        x && V && b.endB == b.start && (e.input.lastAndroidDelete = Date.now()),
          V &&
            !C &&
            w.start() != D.start() &&
            0 == D.parentOffset &&
        ...
        if (C)
          if (w.pos == D.pos)
            O &&
              ...
              setTimeout(() => ke(e), 20)),
              (M = e.state.tr.delete(P, A)),
              (k = p.resolve(b.start).marksAcross(p.resolve(b.endA)));
          else if (
            b.endA == b.endB &&
            (T = (function (e, t) {
              let n,
              ...
              if (1 == d.length && 0 == a.length)
                (o = d[0]),
                  (n = "add"),
                  (s = (e) => e.mark(o.addToSet(e.marks)));
              else {
                if (0 != d.length || 1 != a.length) return null;
                (o = a[0]),
                  (n = "remove"),
                  (s = (e) => e.mark(o.removeFromSet(e.marks)));
              }
              let c = [];
              for (let i = 0; i < t.childCount; i++) c.push(s(t.child(i)));
              if (i.HY.from(c).eq(e)) return { mark: o, type: n };
            })(
              w.parent.content.cut(w.parentOffset, D.parentOffset),
              N.parent.content.cut(N.parentOffset, b.endA - N.start())
            ))
          )
            (M = e.state.tr),
              "add" == T.type
                ? M.addMark(P, A, T.mark)
                : M.removeMark(P, A, T.mark);
          else if (
            w.parent.child(w.index()).isText &&
            w.index() == D.index() - (D.textOffset ? 0 : 1)
          ) {
            let t = w.parent.textBetween(w.parentOffset, D.parentOffset);
            if (e.someProp("handleTextInput", (n) => n(e, P, A, t))) return;
            M = e.state.tr.insertText(t, P, A);
          }
        if (
          (M ||
            (M = e.state.tr.replace(
              P,
              A,
              u.doc.slice(b.start - u.from, b.endB - u.from)
            )),
          u.sel)
        ) {
          let t = un(e, M.doc, u.sel);
          t &&
            !(
              (x &&
                V &&
                ...
                (t.head == P || t.head == M.mapping.map(A) - 1)) ||
              (O && t.empty && t.head == P)
            ) &&
            M.setSelection(t);
        }
      ...
      class gn {
        constructor(e, t) {
          (this._root = null),
            ...
            (this.domObserver = new sn(this, (e, t, n, o) =>
              fn(this, e, t, n, o)
            )),
        ...
        update(e) {
          ...
          (this._props = e),
            e.plugins &&
              (e.plugins.forEach(Dn), (this.directPlugins = e.plugins)),
        ...
        updateStateInner(e, t) {
          ...
          let o = this.state,
            i = !1,
            s = !1;
          e.storedMarks && this.composing && (Tt(this), (s = !0)),
            (this.state = e);
          ...
          (r || t.handleDOMEvents != this._props.handleDOMEvents) && pt(this),
            (this.editable = vn(this)),
            bn(this);
          let l = en(this),
            d = yn(this),
          ...
          (!h && e.selection.eq(o.selection)) || (s = !0);
          let f =
            "preserve" == a &&
            s &&
          ...
          if (s) {
            ...
            if (h) {
              let n = x
                ...
                : null;
              this.composing && (this.input.compositionNode = Et(this)),
        ...
        destroy() {
          this.docView &&
            ...
            this.destroyPluginViews(),
            this.mounted
              ? (this.docView.update(this.state.doc, [], en(this), this),
      ...
      function bn(e) {
        if (e.markCursor) {
          ...
          (t.className = "ProseMirror-separator"),
            ...
            (e.cursorWrapper = {
              dom: t,
              deco: $t.widget(e.state.selection.from, t, {
                raw: !0,
                marks: e.markCursor,
              }),
            });
